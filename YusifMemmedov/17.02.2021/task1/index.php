  ...
  <div class='row pt-3'>
  	<div id='sual' class='col-12'>
  		<div id='primary' class="alert alert-primary">
        	<b id='color'></b> koduna uyghun rengi secin. (ipucu : <b id='hint'></b>)
    	</div>
  	</div>
  	<div class='col-12'>
      	<div id='danger' class="alert alert-danger alert-dismissible">
            <button type="button" class="close" data-dismiss="alert">×</button>
            <strong>Wrong answer!</strong> You failed to answer this question correctly.
        </div>
        <div id='success' class="alert alert-success alert-dismissible">
            <button type="button" class="close" data-dismiss="alert">×</button>
            <strong>Correct answer!</strong> You answered correctly.
        </div>
  	</div>
  	<div class='col-12'>
