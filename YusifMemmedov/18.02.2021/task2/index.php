	...
	<div class='row'>
		...
		<div id='table' class='col-12' style="display: none">
			<div class='d-flex justify-content-center border mx-auto bg-light p-3' style='width:600px'>
				<table class='table'>
					<tr><td>Aşağı temperatur</td><td class='melumat'></td></tr>
					<tr><td>Yuxarı temperatur</td><td class='melumat'></td></tr>
					<tr><td>Hiss olunan</td><td class='melumat'></td></tr>
					<tr><td>Nisbi rütubət</td><td class='melumat'></td></tr>
					<tr><td>Külək</td><td class='melumat'></td></tr>
					<tr><td>Günəş çıxır</td><td class='melumat'></td></tr>
					<tr><td>Günəş batır</td><td class='melumat'></td></tr>
				</table>
			</div>
		</div>
	</div>
