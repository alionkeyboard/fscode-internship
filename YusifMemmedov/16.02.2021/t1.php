...
$sinif = array(
    array('name'=>'Gulay', 'age'=>10, 'gender'=>'q'),
    array('name'=>'Nuray', 'age'=>11, 'gender'=>'q'),
    array('name'=>'Amin', 'age'=>13, 'gender'=>'k'),
    array('name'=>'Huseyn', 'age'=>9, 'gender'=>'k'),
    array('name'=>'Huseyn', 'age'=>9, 'gender'=>'k'),
    array('name'=>'Xadica', 'age'=>15, 'gender'=>'q'),
    array('name'=>'Samir', 'age'=>15, 'gender'=>'k'),
    array('name'=>'Nahid', 'age'=>11, 'gender'=>'k'),
    array('name'=>'Nizam', 'age'=>12, 'gender'=>'k'),
    array('name'=>'Elnaz', 'age'=>10, 'gender'=>'q'),
    array('name'=>'Shabnam', 'age'=>10, 'gender'=>'q')
);
...
<table>
<tbody>
<tr><th>Ad</th><th>Yash</th><th>Cins</th></tr>
<?php 
...
<tbody>
<tr><th colspan=3>Yashda kicik olanlar</th></tr>
<?php 

foreach ($netice['en_kicik'] as $shagird){
    echo "<tr><td>" . $shagird['name'] 
    ."</td><td>" . $shagird['age'] 
    ."</td><td>" . $shagird['gender'] 
    ."</td></tr>";
}
...
<tbody>
<tr><th colspan=3>Yashda boyuk olanlar</th></tr>
<?php 
...
<tbody>
<tr><th colspan=3>Diger gostericiler</th></tr>
<?php 
    echo "<tr><td>Orta yash: " . $netice['orta_yash'] 
    ."</td><td>Qizlarin sayi: " . $netice['qizlarin_sayi'] 
    ."</td><td>Oghlanlarin sayi: " . $netice['oghlanlarin_sayi'] 
    ."</td></tr>";
?>
</tbody>
</table>
