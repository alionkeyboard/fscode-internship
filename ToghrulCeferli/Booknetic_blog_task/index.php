<?php
    ...
    // sehifedeki her bloku elde edirem
    function getBlock($response,$patterns,$i) {
        $blockArr = [];
    ...
    function getData($page) {
        ...
        if(!$response){
            ...
            for($i=0;$i<$arrLen;$i++) {
                // sehifedeki bloklari arrayime elave edirem
                $pageArr[] = getBlock($response,$patterns,$i);
            }
            return $pageArr;
        }
